...
from kernel.observer.observerCreation import ObserverCreator
from kernel.schedule.scheduleCreation import ScheduleCreator
from kernel.space.spaceCreation import SpaceCreator
...
class Model:
    ...
    def __init__(self, simulation, json_model_defs, observers_def, agents_to_create, path_to_runs):
        ...
        self.create_spaces()
        self.create_observers(observers_def, path_to_runs)
    ...
    def create_observers(self, observers_def, path_to_runs):
        """
        ...
        self.agent_observers_pop = ObserverCreator(self, self.simulation,
                                                   self.agent_observers_def, path_to_runs)
